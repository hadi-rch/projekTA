...
<section class="flex items-center hero">
      ...
      >
        <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
          Smartphone <br class="" />Yang Kamu Inginkan
        </h1>
        <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          Kami menyediakan Smartphone
          <br class="hidden lg:block" />Dengan Berbagai Jenis Dan Merk
        </h2>
        <div>
          <a
      ...
      <div class="w-full inset-0 md:relative md:w-1/2">
        <div class="relative hero-image">
          ...
          <img
            src="/frontend/images/content/image-section-2.png"
            alt="hero 1"
        ...
        <div class="grid grid-rows-2 grid-cols-9 gap-4">
          ...
          >
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/image-catalog-10.png"
                alt=""
          ...
          >
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/image-catalog-30.jpg"
                alt=""
                class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
              />
            </div>
          ...
          >
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/image-catalog-40.png"
                alt=""
                class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
              />
            </div>
          ...
          <div class="relative col-span-9 row-span-1 md:col-span-4 card">
            <div class="card-shadow rounded-xl">
              <img
                src="/frontend/images/content/image-catalog-20.png"
                alt=""
                class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl"
              />
            </div>
      ...
      <div class="container mx-auto mb-4">
        <div class="flex justify-center text-center mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            SmartPhone Terbaru <br class="" /> Tersedia Untuk Kamu
          </h3>
        </div>
      </div>
              ...
              <div class="d-flex justify-content-around">
                ...
                @foreach($products as $product)
                  <div class="px-8 relative card group">
                    <div
