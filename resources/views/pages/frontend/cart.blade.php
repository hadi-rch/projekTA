                  ...
                  <div class="flex flex-col mb-4">
                    ...
                    <div class="flex -mx-2 flex-wrap">
                      <div class="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/frontend/images/content/jnt.svg"
                            alt="Logo JNT"
                      ...
                      <div class="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/frontend/images/content/sicepat.svg"
                            alt="Logo Sicepat"
                            class="object-contain max-h-full"
                          />
                        </button>
                  ...
                  <div class="flex flex-col mb-4">
                    ...
                    <div class="flex -mx-2 flex-wrap">
                      ...
                      <div class="px-2 w-6/12 h-24 mb-4">
                        <button
                          type="button"
                          data-value="indomaret"
                          data-name="payment"
                          class="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none"
                        >
                          <img
                            src="/frontend/images/content/indomaret.svg"
                            alt="Indomaret"
                            class="object-contain max-h-full"
                          />
                        </button>
                      ...
                      <div class="px-2 w-6/12 h-24 mb-4">
                        ...
                        >
                          <img
                            src="/frontend/images/content/dana1.svg"
                            alt="dana"
                          />
                        </button>
                      </div>
