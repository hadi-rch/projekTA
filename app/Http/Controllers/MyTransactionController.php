...
class MyTransactionController extends Controller
{
    ...
    public function index()
    {
        if(request()->ajax())
        {
            ...
            return DataTables::of($query)
                ...
                return '
                    <a href="'. route('dashboard.my-transaction.show', $item->id) .'" class="bg-yellow-400 text-black rounded-md px-2 py-1 m-2">
                        Show
                    </a>
                ';
                })
    ...
    public function show(Transaction $myTransaction)
    {
        ...
        // return view('pages.dashboard.transaction.show',compact('query'));
